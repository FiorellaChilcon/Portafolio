...
export default function Sidebar() {
  ...
  return (
    <>
    <nav ref={navRef} className={clsx('lg:bg-softBlue lg:shadow-none bg-softBlue-1 shadow-lg fixed right-0 top-0 h-screen items-center pr-5 w-32 justify-end lg:flex z-10 transition-all', showSidebar ? 'flex' : 'hidden')}>
    ...
    <button
      ...
      className={clsx('bg-softBlue-1 fixed right-0 bottom-0 size-10 rounded-full shadow-xl m-4 border evenly-shadow border-gray-100 flex lg:hidden z-20 transition-all', showSidebar && 'right-24')}
    >
